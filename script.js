var gamesList = [{
  ...
  gameOpinion1: ["It was probably the hardest game I played.", "Last time I checked, I was stuck in the Swamp Palace.", "Help" ]
  ...
  gameOpinion3: ["You can wear a red crop top, while slightly overweight and still feel good. Thanks Diddy Kong.", "I also have the second game where Diddy and Dixie embark a journey to rescue Donkey Kong. I just assumed the kids were brother and sister. They're not. ", "MINDBLOWING."]
  ...
  gameOpinion4: ["This is the most boring game I have ever played. Ever.", "You just open gates and kill dinosaurs.", 'I don\'t know why I put this on, don\'t play this game.']
...
function changeInfo(game) {
  ...
  //calling the first opinion bullet id
  var gameOpinion1 = document.getElementById('gameOpinion1');
  var photoUrl = '';
  ...
  if(game === 'zelda') {
    ...
    gameDescription.innerHTML = gamesList[0].gameDescription
	//append it to the HTML page like you did with gameOpinion, and call the first index of that array like I did below:
	 gameOpinion1.innerHTML = gamesList[0].gameOpinion[0] //first index of gameOpinion array
   gameOpinion1.innerHTML = gamesList[0].gameOpinion[1]
   gameOpinion1.innerHTML = gamesList[0].gameOpinion[2]
	...
	//your issue was that you were appending the gameName tag to the page and so it was only displaying the game name not the other values in your game name object
    gameDescription.innerHTML = gamesList[1].gameDescription; //notice how I did 'gameDescription.innerHTML' and not 'gameName.innerHTML'
    gameOpinion2.innerHTML = gamesList[1].gameOpinion[0]
    gameOpinion2.innerHTML = gamesList[1].gameOpinion[1]
    gameOpinion2.innerHTML = gamesList[1].gameOpinion[2]
    gameOpinion2.innerHTML = gamesList[1].gameOpinion[3]
  }
      ...
      gameDescription.innerHTML = gamesList[2].gameDescription;
      gameOpinion3.innerHTML = gamesList[2].gameOpinion[0]
      gameOpinion3.innerHTML = gamesList[2].gameOpinion[1]
      gameOpinion3.innerHTML = gamesList[2].gameOpinion[2]
    }
      ...
      gameDescription.innerHTML = gamesList[3].gameDescription;
      gameOpinion4.innerHTML = gamesList[3].gameOpinion[0]
      gameOpinion4.innerHTML = gamesList[3].gameOpinion[1]
      gameOpinion4.innerHTML = gamesList[3].gameOpinion[2]
    }
}
